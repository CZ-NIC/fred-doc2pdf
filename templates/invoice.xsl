...
<template pageSize="(21cm, 29.7cm)" leftMargin="2.0cm" rightMargin="2.0cm" topMargin="2.0cm" bottomMargin="2.0cm" 
  ...
  >
    ...
    <!-- end of header -->
        ...
        <setFont name="Times-Bold" size="10"/>
        <drawString x="2cm" y="18.1cm"><xsl:value-of select="$loc/str[@name='Invoice No']"/>:</drawString>
        <drawString x="2cm" y="17.7cm"><xsl:value-of select="$loc/str[@name='Variable symbol']"/>:</drawString>
        ...
        <drawString x="10.4cm" y="17.7cm"><xsl:value-of select="$loc/str[@name='Invoice date']"/>:</drawString>
        <drawString x="10.4cm" y="17.3cm"><xsl:value-of select="$loc/str[@name='Tax point']"/>:</drawString>
...
<para>
<xsl:value-of select="$loc/str[@name='VAT-settled-deposit']"/>:
</para>
...
<tr>
    <td><xsl:value-of select="$loc/str[@name='Invoice no']"/></td>
